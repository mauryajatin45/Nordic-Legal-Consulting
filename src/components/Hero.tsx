    ...
    return (
      ...
      >
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">{t.successTitle}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" role="form">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full p-3 rounded-lg bg-white/70 border border-white/40 text-gray-900"
                placeholder={language === 'en' ? '+45 123 456 78' : '+45 123 456 78'}
                required
                pattern="^\+?[0-9\s\-\(\)]{8,20}$"
              />
              <ValidationError 
            ...
            <div>
              ...
              <select
                ...
                required
              >
                <option value="">{language === 'en' ? 'Select purpose...' : 'Vælg formål...'}</option>
            ...
            <button
              ...
              className={`w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold transition-all duration-300 ${
                state.submitting ? 'opacity-70 cursor-not-allowed' : 'hover:opacity-90'
              }`}
            >
              {state.submitting ? (
